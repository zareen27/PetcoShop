        ...
        <header>
            ...
            <div class="hero container">
                ...
                <div class="hero-image">
                    <img src="{{ URL::to('/assets/logo.png') }}" alt="hero image">
                </div>
            </div> <!-- end hero -->
        </header>
        ...
        <div class="featured-section">
            <div class="container">
                ...
                <div class="products text-center">
                    <div class="product">
                        <a href="#"><img src="{{ URL::to('/assets/logo.png') }}" alt="product"></a>
            ...
            <div class="container">
                ...
                <div class="blog-posts">
                    <div class="blog-post" id="blog1">
                        <a href="#"><img src="{{ URL::to('/assets/logo.png') }}" alt="blog image"></a>
